...
//$fb_share_url = "https://apps.facebook.com/" . $aa['instance']['fb_app_url'] . "/share.php?aa_inst_id=" . $aa['instance']['aa_inst_id'];

$fb_share_url = $aa['instance']["fb_canvas_url"] . "share.php?aa_inst_id=" . $aa['instance']['aa_inst_id'];
...
{
    $redirect_url = $aa['instance']["fb_canvas_url"] . "index.php?aa_inst_id=" . $aa['instance']['aa_inst_id'];
}
